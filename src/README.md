...
*   **`slurm/`**: *Scripts* de tipo bash (`.sh`) encargados de orquestar la ejecución de los experimentos en la supercomputadora Clementina XXI mediante el sistema de colas Slurm (e.g., `sbatch`).
